...
splits_path = join(INTERACTIONS_PATH, 'splits')
...
class ProstateDataPaper():
    ...
    def get_train_validate_test(self):
        ...
        # training_set['id'] = training_set['id'].astype('int64')
        ...
        intersection = info.intersection(training_set.id)
        # print('intersection:')
        # print(intersection)
        # print('count:')
        ...
        # print('set(info).intersection(training_set.id)')
        # print(set(info).intersection(training_set.id))

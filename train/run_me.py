...
from config_path import ENH_LOG_PATH, POSTATE_PARAMS_PATH
...
for params_file in params_file_list:
    ...
    #params = importlib.load_source(params_file, params_file_full)
    loader = importlib.machinery.SourceFileLoader('params', params_file_full)
